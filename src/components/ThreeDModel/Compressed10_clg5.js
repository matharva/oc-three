...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/compressed10_clg5.glb')
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      />
      <mesh
        geometry={nodes['travnikova-cesta'].geometry}
        material={nodes['travnikova-cesta'].material}
        position={[202.5, -0.47, -149.45]}
        scale={[1, 1, 1.42]}
      />
      <mesh
        geometry={nodes['travnikova-cesta001'].geometry}
        material={nodes['travnikova-cesta001'].material}
        position={[202.5, -0.47, -207.12]}
        scale={[1, 1, 1.42]}
      />
      <mesh
        geometry={nodes['travnikova-cesta002'].geometry}
        material={nodes['travnikova-cesta002'].material}
        position={[250.08, -0.47, -281.04]}
        rotation={[0, Math.PI / 2, 0]}
        scale={[1.28, 1, 2.03]}
      />
      <mesh
        geometry={nodes['travnikova-cesta003'].geometry}
        material={nodes['travnikova-cesta003'].material}
        position={[320.86, -0.47, -281.04]}
        rotation={[0, Math.PI / 2, 0]}
        scale={[1.28, 1, 1.42]}
      />
      <mesh
        geometry={nodes['travnikova-cesta004'].geometry}
        material={nodes['travnikova-cesta004'].material}
        position={[372.49, -0.47, -281.04]}
        rotation={[0, Math.PI / 2, 0]}
        scale={[1.28, 1, 1.1]}
      />
      <mesh
        geometry={nodes['travnikova-cesta005'].geometry}
        material={nodes['travnikova-cesta005'].material}
        position={[202.07, -0.47, -254.41]}
        rotation={[-Math.PI, 0, -Math.PI]}
        scale={[1.03, 1, 0.89]}
      />
      <mesh
        geometry={nodes['travnikova-cesta006'].geometry}
        material={nodes['travnikova-cesta006'].material}
        position={[405.83, -0.47, -150.06]}
        scale={[1, 1, 1.42]}
      />
      <mesh
        geometry={nodes['travnikova-cesta007'].geometry}
        material={nodes['travnikova-cesta007'].material}
        position={[405.83, -0.47, -207.73]}
        scale={[1, 1, 1.42]}
      />
      <mesh
        geometry={nodes['travnikova-cesta008'].geometry}
        material={nodes['travnikova-cesta008'].material}
        position={[405.41, -0.47, -255.03]}
        rotation={[-Math.PI, 0, -Math.PI]}
        scale={[1.03, 1, 0.89]}
      />
      <mesh
        geometry={nodes['travnikova-cesta009'].geometry}
        material={nodes['travnikova-cesta009'].material}
        position={[405.83, -0.47, -104.42]}
        scale={[1, 1, 1.03]}
      />
      <mesh
        geometry={nodes['travnikova-cesta010'].geometry}
        material={nodes['travnikova-cesta010'].material}
        position={[324.48, -0.47, -78.87]}
        rotation={[0, Math.PI / 2, 0]}
        scale={[0.69, 1, 1.42]}
      />
      <mesh
        geometry={nodes['travnikova-cesta011'].geometry}
        material={nodes['travnikova-cesta011'].material}
        position={[376.12, -0.47, -78.87]}
        rotation={[0, Math.PI / 2, 0]}
        scale={[0.69, 1, 1.1]}
      />
    </group>
...
useGLTF.preload('/compressed10_clg5.glb')
